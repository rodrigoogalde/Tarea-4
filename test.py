...
# cat = RLCat(game.cat_pos, "QTableCat1000.npy")        # Reemplazar con el nombre del archivo de la Q-Table
mouse = RLMouse(game.mouse_pos, "QTableMouse1000.npy")  # Reemplazar con el nombre del archivo de la Q-Table
